...
package com.android.settings.devilian;
...
public class AccentPicker extends InstrumentedDialogFragment implements OnClickListener {
    ...
    private boolean isUsingDarkTheme() {
        ...
        try {
            themeInfo = mOverlayManager.getOverlayInfo("com.android.system.theme.dark.devilian",
    ...
    private boolean isUsingBlackTheme() {
        OverlayInfo themeInfo = null;
        try {
            themeInfo = mOverlayManager.getOverlayInfo("com.android.system.theme.black.devilian",
                    UserHandle.USER_CURRENT);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
